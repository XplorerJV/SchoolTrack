...
<div class="page-header">
    <div class="header-content">
        <h1><i data-feather="layers"></i> Classes Management</h1>
        <p>Monitor all classes, attendance and performance</p>
    </div>
</div>
...
<div class="page-content">
    ...
    <div class="card">
        <div class="card-header">
            <h3><i data-feather="layers"></i> All Classes (<?= count($classes) ?>)</h3>
        </div>
        <div class="card-body" style="padding:0">
            <?php if (empty($classes)): ?>
            <div style="padding:40px;text-align:center;color:#6b7280">No classes found. Add students first.</div>
            <?php else: ?>
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align:center">Marked Today</th>
                    ...
                    ?>
                    <tr>
                        <td><strong style="font-size:16px">Class <?= htmlspecialchars($cls['class']) ?></strong></td>
                        <td style="text-align:center"><span class="badge" style="background:#dbeafe;color:#1e40af"><?= $cls['total_students'] ?></span></td>
                        <td style="text-align:center">
                            <span class="badge" style="background:#f1f5f9;color:#475569"><?= $cls['marked_today'] ?>/<?= $cls['total_students'] ?></span>
                        </td>
                        ...
                        <td style="text-align:center">
                            <div class="action-buttons" style="justify-content:center">
                                <a href="../teacher/mark-attendance.php?class=<?= urlencode($cls['class']) ?>" class="btn btn-sm btn-primary">
                                    <i data-feather="check-square"></i> Mark
                                </a>
                                <a href="class-performance.php?class=<?= urlencode($cls['class']) ?>" class="btn btn-sm btn-secondary">
