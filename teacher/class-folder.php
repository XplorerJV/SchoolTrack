...
<div class="page-header">
    ...
    <div style="display:flex;gap:8px;flex-wrap:wrap">
        ...
        <a href="mark-attendance.php?class=<?= urlencode($selectedClass) ?>&date=<?= urlencode($attendanceDate) ?>&period=<?= $selectedPeriod ?>" class="btn btn-info"><i data-feather="check-square"></i> Mark Now</a>
    </div>
</div>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center">
                            <div style="display:flex;gap:6px;justify-content:center">
                                <a href="mark-attendance.php?class=<?= urlencode($selectedClass) ?>&date=<?= urlencode($attendanceDate) ?>&period=<?= $selectedPeriod ?>" class="btn btn-sm btn-info" title="Mark Attendance"><i data-feather="edit-2"></i></a>
                            </div>
                        </td>
                    </tr>
                    <?php endforeach; ?>
